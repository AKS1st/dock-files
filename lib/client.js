	...
	factory: (require) => {
		...
		*/
		...
		function ExplorerView(props) {
			...
			*/
			const probeClipboardImage = () => {
				setImageProbe("unknown");
				(async () => {
					let has = false;
					try {
						if (typeof navigator.clipboard !== "undefined" && typeof navigator.clipboard.read === "function") has = (await navigator.clipboard.read()).some((item) => item.types.some((type) => type.startsWith("image/")));
					} catch {
						has = false;
					}
			...
			*/
			...
			const buildMenuItems = () => {
				...
				if (target.kind === "empty") {
					if (root === null) return [];
					const label = clipboard === null ? t("paste") : t("pasteWithName", { name: baseNameOf$1(clipboard.path) });
					return [
				...
				if (target.kind === "dir") {
					const pasteLabel = clipboard === null ? t("paste") : t("pasteWithName", { name: baseNameOf$1(clipboard.path) });
					return [
			...
			return (0, react.createElement)("div", {
				...
				title: t("collapseAll"),
				onClick: collapseAll
			}, (0, react.createElement)("span", { className: "df-icon-stack" }, chevronUpIcon(10), chevronUpIcon(10))), (0, react.createElement)("button", {
				className: "df-icon-btn",
