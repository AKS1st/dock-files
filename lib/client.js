	...
	factory: (require) => {
		...
		function TransferView({ ctx }) {
			...
			return (0, react.createElement)("section", { className: "df-transfer-view" }, (0, react.createElement)("header", { className: "df-transfer-header" }, (0, react.createElement)("div", { className: "df-transfer-title" }, transferIcon(), (0, react.createElement)("span", null, t("transferCenter"))), (0, react.createElement)("div", { className: "df-transfer-summary" }, t("transferSummary", {
				...
				return (0, react.createElement)("article", {
					className: "df-transfer-row",
					key: task.id
				}, (0, react.createElement)("div", { className: "df-transfer-main" }, (0, react.createElement)("div", {
					className: "df-transfer-name",
					title: task.name
				}, task.name), (0, react.createElement)("div", { className: "df-transfer-kind" }, `${t(task.kind === "upload" ? "upload" : "download")} · ${statusLabel(task.status, t)}`)), (0, react.createElement)("div", { className: "df-transfer-paths" }, (0, react.createElement)("span", { title: task.sourcePath }, task.sourcePath), (0, react.createElement)("span", {
					className: "df-transfer-path-arrow",
					"aria-hidden": true
				}, "→"), (0, react.createElement)("span", { title: task.targetPath ?? "" }, task.targetPath ?? "—")), (0, react.createElement)("div", { className: "df-transfer-progress" }, (0, react.createElement)("div", { className: "df-transfer-progress-track" }, (0, react.createElement)("div", {
					className: "df-transfer-progress-fill",
					style: { width: `${progress}%` }
				})), (0, react.createElement)("span", null, `${progress}% · ${formatBytes(task.transferredBytes)} / ${formatBytes(task.totalBytes)}`)), (0, react.createElement)("div", { className: "df-transfer-actions" }, canPause ? actionButton(t("pause"), () => {
					pauseTask(task.id);
		...
		*/
		...
		function ExplorerView(props) {
			...
			(0, react.useSyncExternalStore)(subscribe ?? TRANSFER_NOOP_SUBSCRIBE, getSnapshot);
			const locale = useLocale(ctx);
			...
			const [clipboardProbe, setClipboardProbe] = (0, react.useState)("unknown");
					...
					try {
						if (typeof navigator.clipboard !== "undefined" && typeof navigator.clipboard.read === "function") {
							...
							for (const item of items) {
								...
								hasFile ||= item.types.some((type) => type === "Files" || type === "text/uri-list" || type === "application/octet-stream" || type === "application/x-moz-file" || type.endsWith("/file"));
							}
						}
					} catch {}
			...
			*/
			...
			const buildMenuItems = () => {
				...
				const pasteOrUploadItem = (dest) => clipboardProbe === "file" ? menuItem("upload", uploadIcon(13), t("upload"), () => chooseUpload(dest)) : menuItem("paste", pasteIcon(13), clipboard === null ? t("paste") : t("pasteWithName", { name: baseNameOf$1(clipboard.path) }), () => pasteInto(dest), clipboard === null);
			...
			}, folderIcon(true, 13), (0, react.createElement)("span", null, root ?? "…")), (0, react.createElement)("input", {
				ref: uploadInputRef,
				type: "file",
				multiple: true,
				hidden: true,
			...
			}, t("emptyDir"))] : rows), menuEl !== null ? (0, react_dom.createPortal)(menuEl, document.body) : null, dialogEl !== null ? (0, react_dom.createPortal)(dialogEl, document.body) : null);
		}
		//#endregion
...
`;
		...
		*/
		...
		function FilesHeaderActions(_props) {
			const transferSnapshot = (0, react.useSyncExternalStore)(subscribe, getSnapshot);
			const progress = transferSnapshot.activeCount > 0 && transferSnapshot.totalBytes > 0 ? Math.min(100, Math.round(transferSnapshot.totalTransferred / transferSnapshot.totalBytes * 100)) : 0;
			...
			return (0, react.createElement)("div", { className: "df-shell-actions" }, (0, react.createElement)("div", { className: "df-shell-action-row" }, button("upload", "上传", uploadIcon(14)), button("refresh", "刷新", refreshIcon(14)), button("collapse", "折叠全部", collapseAllIcon(14)), button("transfers", "打开传输中心", transferIcon(14))), (0, react.createElement)("div", {
				className: "df-shell-progress",
				title: transferSnapshot.activeCount > 0 && transferSnapshot.totalBytes > 0 ? `传输中 ${progress}%` : void 0
			}, (0, react.createElement)("div", {
