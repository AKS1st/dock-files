		...
		*/
		...
		function ExplorerView(props) {
			...
			*/
			...
			const renderLevel = (list, depth, ancestors) => {
				...
				for (let index = 0; index < count; index += 1) {
					...
					rows.push((0, react.createElement)("div", {
						...
						className: rowClass,
						title: entry.path,
						onClick: isRenaming ? void 0 : () => toggle(entry),
						onContextMenu: (event) => {
			...
			}, "空目录")] : rows), menuEl !== null ? (0, react_dom.createPortal)(menuEl, document.body) : null, dialogEl !== null ? (0, react_dom.createPortal)(dialogEl, document.body) : null);
		}
		//#endregion
