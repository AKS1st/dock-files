		...
		*/
		...
		function ExplorerView(props) {
			...
			*/
			...
			return (0, react.createElement)("div", {
			...
			}, (0, react.createElement)("div", { className: "df-header" }, (0, react.createElement)("div", {
			...
			}, folderIcon(true, 13), (0, react.createElement)("span", null, root ?? "…")), (0, react.createElement)("div", { className: "df-toolbar" }, (0, react.createElement)("input", {
				ref: uploadInputRef,
				type: "file",
				multiple: true,
				hidden: true,
			...
			}, uploadIcon(14)), (0, react.createElement)("button", {
				className: "df-icon-btn",
				title: t("refresh"),
				disabled: loading,
				onClick: () => {
				...
				title: t("collapseAll"),
				onClick: collapseAll
			}, collapseAllIcon(14)), (0, react.createElement)("button", {
				className: "df-icon-btn",
				title: t("openTransferCenter"),
				onClick: () => openTransferView(ctx.get("workbench"))
			}, transferIcon(14))), (0, react.createElement)("div", {
				className: "df-progress",
				title: transferSnapshot.activeCount > 0 && transferSnapshot.totalBytes > 0 ? t("transferSummary", {
					active: transferSnapshot.activeCount,
					progress: Math.round(transferSnapshot.totalTransferred / transferSnapshot.totalBytes * 100)
				}) : void 0
			}, (0, react.createElement)("div", {
				className: "df-progress-fill",
				style: { width: transferSnapshot.activeCount > 0 && transferSnapshot.totalBytes > 0 ? `${Math.min(100, Math.round(transferSnapshot.totalTransferred / transferSnapshot.totalBytes * 100))}%` : "0%" }
			}))), (0, react.createElement)("div", {
