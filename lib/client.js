...
`;
		...
		*/
		...
		function FilesHeaderActions(_props) {
			...
			return (0, react.createElement)("div", { className: "df-shell-actions" }, button("upload", "上传", uploadIcon(14)), button("refresh", "刷新", refreshIcon(14)), button("collapse", "折叠全部", collapseAllIcon(14)), button("transfers", "打开传输中心", transferIcon(14)), (0, react.createElement)("div", {
